...
export type ControlTip = typeof CONTROL_TIPS[number];
...
export type FabricEvent = typeof FABRIC_EVENTS[keyof typeof FABRIC_EVENTS];
...
export type CursorAnimal = typeof CURSOR_ANIMALS[number];
...
export type FabricObjectProp = typeof FABRIC_OBJECT_PROPS[number];
