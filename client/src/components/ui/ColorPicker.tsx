...
const saveRecentColor = (color: string, recentColors: string[]): string[] => {
...
const ColorPicker = React.memo(function ColorPicker({
  ...
  const handleColorSelect = useCallback((color: string, fromPanel = false) => {
    onColorChange(color);
        ...
        >
          ...
          <div className="flex items-center gap-2 pt-2 border-t border-gray-100">
            ...
            <input
              type="color"
              value={currentColor}
              onChange={(e: ChangeEvent<HTMLInputElement>) => handleColorSelect(e.target.value, true)}
