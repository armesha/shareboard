...
const OptionsMenu = React.memo(function OptionsMenu({
  ...
  const [fullCanvasImage, setFullCanvasImage] = useState<string | null>(null);
  const [canvasDimensions, setCanvasDimensions] = useState<{ width: number; height: number } | null>(null);
  const [objectsBounds, setObjectsBounds] = useState<{ left: number; top: number; width: number; height: number } | null>(null);
