...
function FloatingCursor({ color, name, className, style }: FloatingCursorProps) {
  return (
...
interface WorkspaceExistsResult {
  exists: boolean;
}
...
export default function LandingPage() {
  ...
  const demoCursors: DemoCursor[] = useMemo(() => [
  ...
  const joinWorkspace = useCallback((e: FormEvent<HTMLFormElement>): void => {
    ...
    const handleResult = ({ exists }: WorkspaceExistsResult): void => {
